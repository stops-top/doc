...
通过通信扩展线缆和存储扩展线缆，实现功能分离管理，其中的高速通信和高速储存可用于实时监控设备信息，通过预警诊断机制，提供更智能的服务。

通信扩展线缆用于实现无线通信，储存和监测底板用于管理设备状态并记录数据
...
具备USB通信能力，可以建立分叉树USB通信网络，实现层级封装，便于对接不同的平台

* 具备信号探测能力，可以监控对应的IO电气状态
* 具备日志记录能力，可以满足持久化储存的需要

接口定义
~~~~~~~~~~~
``7.9x8.9mm`` ``24P``

`U262-241N-4BVC16 24P <https://item.szlcsc.com/363931.html>`_

.. image:: ./images/usbc-24p.png
    :target: https://item.szlcsc.com/363931.html


通信线缆
-----------

扩展通信能力，可以扩展各种电气状态的信号和不同的无线网络
